...
// const bmiOfMark = massMark / heightOfMark ** 2;
// console.log("Mark's BMI: " + bmiOfMark);

// const bmiOfJohn = massJohn / heightOfJohn ** 2;
...
//     console.log(`Mark's BMI (${bmiOfMark}) is higher than John's!`)
// } else {
...
// if (teamDolphins >= minimumScore && teamDolphins > teamKoalas) {
//     console.log(`Dolphins won`)
// } else if (teamKoalas >= minimumScore && teamKoalas > teamDolphins) {
//     console.log(`Koalas won`)
// } else if (teamDolphins === teamKoalas && teamDolphins >= minimumScore && teamKoalas >= minimumScore) {
...
// console.log(`The bill was ${bill}, tip was ${tip} and the total value ${bill + tip}`);
